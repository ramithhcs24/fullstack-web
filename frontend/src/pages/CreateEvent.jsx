    ...
    <div>
      ...
      <section className="mx-auto w-full max-w-3xl px-4 py-12 lg:px-6">
        <form
          ...
          className="grid gap-4 rounded-3xl border border-slate-200 bg-white/5 p-6 shadow-sm md:grid-cols-2"
        >
          <input
            type="text"
          ...
          <div className="flex flex-wrap gap-3 md:col-span-2">
            <button className="rounded-xl bg-indigo-500 px-6 py-3 font-semibold text-white transition hover:bg-indigo-400">
              Publish Event
            </button>
            <Link
              to="/campus-life"
